...
public interface IdProvider {
    ...
    String createDataStreamDataId(HubContext ctx, String dataStreamId);
    String createDataStreamFieldId(HubContext ctx, String dataStreamId, String fieldId);
    String createDataStreamFieldsId(HubContext ctx, String dataStreamId);
    String createDataStreamTagsId(HubContext ctx, String dataStreamId);
    DeviceContext createDeviceContext(String deviceId);
    DeviceContext createDeviceContextWithHub(HubContext ctx, String deviceId);
    String createDeviceActionClassId(DeviceContext ctx, String actionClassId);
    String createDeviceActionClassesId(DeviceContext ctx);
